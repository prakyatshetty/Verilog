...
HD_PWD='C:/Users/praky/FullAdder/FullAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_4bit.tcl
